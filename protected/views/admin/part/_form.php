...
<?php $form=$this->beginWidget('CActiveForm', array(
    ...
    <?php if($model->image) {?>
        <?php echo CHtml::image( '/upload/part/'.$model->image ); ?>
    <?php }?>
    ...
    <div class="row">
    <?php echo $form->labelEx($model,'car_list'); ?>
        <?php echo CHtml::checkBoxList('Part[car_list]',PartCar::loadCar($model->id),CHtml::listData(Car::model()->findAll(),'id','name'),array('separator'=>'')) ?>
        <?php echo $form->error($model,'car_list'); ?>
    </div>

	<div class="row label-fl-l">
